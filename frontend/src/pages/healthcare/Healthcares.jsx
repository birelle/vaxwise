...
function DoctorsList() {
  ...
  return (
    <div className="p-8">
    <CreateHealthcare onClose={()=>{setAddHealthcare(!addHealthcare)}} open={addHealthcare}/>
      ...
      <button onClick={()=>{setAddHealthcare(true)}} className="fixed bottom-10 right-10 bg-teal-600 text-white p-4 w-12  h-12 rounded-full shadow-lg hover:bg-teal-700">
        +
      </button>
    </div>
  );
